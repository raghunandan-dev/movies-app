...
var Movie_1 = require("../app/models/Movie");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, Movie_1.default.updateMany({ userId: { $exists: false } }, // or { userId: null }
                        { $set: { userId: user._id } })];
                case 3:
                    result = _a.sent();
                    console.log("Updated ".concat(result.modifiedCount, " movies with userId ").concat(user._id));
